 ...
 * @author julianalonso
 */
public class SelectDestinyDialog extends JDialog {
    ...
    public SelectDestinyDialog(boolean needExtension) {
    ...
    private ActionListener getcloseAction() {
        return (ActionEvent e) -> {
            ...
            if (workbench == null || name.getText().equals("")) {
                ...
                if (this.needExtension)
                    destiny.setName(name.getText() + ".box");
                else
    ...
    private void initComponents() {
        ...
        this.folderLabel = new JLabel("Destino");
    ...
    private void configDialog() {
        ...
        setTitle("Selecciona carpeta de destino");
